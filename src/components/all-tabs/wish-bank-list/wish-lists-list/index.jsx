...
const WishListsLists = () => { 
    ...
    */
    const GetEvent = async (search, page) => { 
        ...
        try {
            const Response = await makeRequest('GET', 'wish/list', { type: "my", search: search, limit: "10", page: page, list_type: "general" }, Token,)
        ...
        >
            ...
            />
            {
                (!WishListData || WishListData?.length === 0) ? (
                    ...
                    <NotFound title="common.notFoundText" />
                )
            }
        </ScrollView>
